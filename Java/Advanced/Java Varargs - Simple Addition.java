...
public class Solution {
    ...
    private void solve(Printer p, int testcase) throws Exception {   
         ...
         System.out.printf("%d+%d=%d",a[0],a[1],s[1]);System.out.println();
         System.out.printf("%d+%d+%d=%d",a[0],a[1],a[2],s[2]);System.out.println();
         System.out.printf("%d+%d+%d+%d+%d=%d",a[0],a[1],a[2],a[3],a[4],s[4]);System.out.println();
         System.out.printf("%d+%d+%d+%d+%d+%d=%d",a[0],a[1],a[2],a[3],a[4],a[5],s[5]);System.out.println();
